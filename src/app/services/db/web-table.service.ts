...
export class WebTableService implements InMemoryDbService {
  createDb() {
    ...
    const formats: Format[] = [
      { id: 1, name: 'Web gallery', url: 'web', imgSrc: 'assets/_include/img/profile/web-gallery6.png', desc: 'Discover our gallery of ready-to-use rich media ad formats for your display campaigns: expandable, video, native ads, rising stars and more. The simplest way to build and deliver great ad experiences.' },
      { id: 2, name: 'Mobile gallery', url: 'mobile-web', imgSrc: 'assets/_include/img/profile/mobile-gallery6.png', desc: 'Rich media on mobile and tablets at your fingertips …	Smart AdServer provides customizable ad templates for mobile web and mobile applications to deliver amazing ad experiences without any technical expertise. Check out the mobile rich media gallery.' },
      { id: 3, name: 'Video gallery', url: 'video', imgSrc: 'assets/_include/img/profile/video-gallery6.png', desc: 'Video is definitively one of the most efficient support for digital advertising campaigns. Browse our selection of video in-stream and out-stream ad formats and see how Smart AdServer customers are using them to drive ad effectiveness.' },
      { id: 4, name: 'RTB+ gallery', url: 'rtb', imgSrc: 'assets/_include/img/profile/RTB-gallery6.png', desc: 'Are you looking for an inspiration for your RTB campaign? Visit our RTB gallery and explore the variety of ad formats available for all platforms and devices. Pick your favorite ad unit and drive your revenue with Smart AdServer.' }
    ];
